...
$sql_news = "SELECT * FROM news order by date desc ,id_news desc";
...
<table width="95%" border="0" cellpadding="4" cellspacing="1" bgcolor=#66CCFF" align="center">
<tr>
<td height="120" bgcolor="#FFFFFF">
<br>
<h2><?php echo $data_judul; ?></h2>
