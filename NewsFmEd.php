...
?>
<form action="NewsFmEdSim.php" method="post" name="form1">

<table width="550" border=0 align="center" style="padding:15">
<tr>
  <td colspan ="2" bgcolor="#00CCFF"><b>FORM UBAH BERITA</b></td>
</tr>
<tr>
  <td width="117">&nbsp</td>
  <td width="321">&nbsp</td>
</tr>
<tr>
  <td>Judul Berita</td>
  <td><input name="TxtJudul" type="text" size="50" 
  value="<?php echo "$data_judul"; ?>" maxlength="100">
  <input name="TxtIdH" type="hidden" 
  value="<?php echo "$data_idnews"; ?>"></td>
</tr>
<tr>
  <td>Isi Berita</td>
  <td><textarea name="TxtBerita" cols="52" rows="5"> 
  <?php echo "$data_berita"; ?></textarea>
  </td>
</tr>
<tr>
  <td>Pengirim</td>
  <td><input name="TxtPengirim" type="text" size="50" 
  value="<?php echo "$data_pengirim"; ?>" maxlength="60">
  </td>
</tr>
<tr>
  <td>Tanggal Baca</td>
...
<tr>
 ...
 <input name="gagal" type="reset" value="Reset"> 
  </td>
</tr>
</table>
</form>
