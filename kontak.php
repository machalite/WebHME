...
<head>
<title>Kontak_KOPERASI ISMUJM</title>
<meta charset="utf-8">
...
<img1><img src="images/view2.jpg" width=100%></img1>
<div id="fp"><b>Kontak Koperasi Tanjung Pasir...<br></b>
<table border=0 width=100%>
<tr>

	<td align="right" bg-color="white"><p style="font-size: 25px">
	<br><b>Nama :<br></b>Pomang<br><br>
	<b>Nomor HP:<br></b>021-91024387<br><br>
	</tr>
	</td>
	<tr>
	<td align="right"><p style="font-size: 25px">
	<br><b>Email :<br></b>
	koperasi_ismujm@yahoo.co.id<br><br></td>
	</tr>
	<tr><td width=100% colspan=2 align="right"><p style="font-size: 25px">
	<br><b>Alamat :<br></b>
	Jl. Raya Tanjung Pasir RT 01/01,<br>Rumah Pintar POSAL Teluknaga,<br>Tangerang Banten, 15510<br><br>
	</td></font>
	</p></center>
	</td>
	</tr>
...
<td align="center" bgcolor="grey"><img src="images/peta.png"></td>
<td bgcolor="grey"><font color="white"><p style="font-size:30">Desa Tanjung Pasir terletak di Utara Jakarta dengan jarak kira-kira 47 km dari kampus UNIKA Atma Jaya.
</td></p>
</table></center>
<br>
