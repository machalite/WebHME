...
<head>
<title>Penjualan Koperasi ISMUJM</title>
<meta charset="utf-8">
...
<table border=1>
	<tr>
	<td width=10% bgcolor="ffcc99"><b>Kode Penjualan</b></td>
	<td width=20% bgcolor="ffcc99"><b>Nama produk</b></td>
	<td width=10% bgcolor="ffcc99"><b>Harga</b></td>
	<td width=10% bgcolor="ffcc99"><b>Jumlah pembelian</b></td>
	<td width=10% bgcolor="ffcc99"><b>Total pembelian</b></td>
	<td width=20% bgcolor="ffcc99"><b>Tanggal pembelian</b></td>
	<td width=20% bgcolor="ffcc99"><b>Waktu pembelian</b></td>
	</tr>

<?php
include_once "koneksi.php";
$query="SELECT * FROM penjualan ORDER BY tanggal,waktu";
...
?>
	<tr>
	<td bgcolor="fff2e5"><?php echo $tampil['kd_penjualan'] ?></td>
	<td bgcolor="ffffe5"><?php echo $tampil['nama_produk'] ?></td>
	<td bgcolor="fff2e5"><?php echo $tampil['harga'] ?></td>
	<td bgcolor="ffffe5"><?php echo $tampil['jlh_beli'] ?></td>
	<td bgcolor="fff2e5"><?php echo $tampil['total'] ?></td>
	<td bgcolor="ffffe5"><?php echo $tampil['tanggal'] ?></td>
	<td bgcolor="fff2e5"><?php echo $tampil['waktu'] ?></td>
	</tr>
<?php
}
?>
