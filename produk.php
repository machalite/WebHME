...
?>
	...
	<tr>
	<td rowspan=3 height=350 width=25% style="padding:10"><img  style="border-radius:15px" width=100% height=100% src="images/<?php echo "$tampil[gambar]"?>"></td>
	<td colspan=3 style="font-family:verdana ; color:darkslategray ; font-size:28"><b><u><?php echo "$tampil[nama_barang]"; ?></b></u></td>
	</tr>

	<tr>
	<td colspan=3 style="font-family:arial ; color:gray;font-size:24"><?php echo "$tampil[deskripsi]"; ?></td>
	</tr>

	<tr>
	<td style="font-family:impact ; font-size:28; color:red">Rp. <?php echo "$tampil[harga]"; ?>,00</td>
	<td style="font-family:verdana ; font-size:24">Stok tersedia : <?php echo "$tampil[jlh_stok]"; ?></td>
	<td style="font-family:verdana ; font-size:24; color:orange; background-color:dimgray; border-radius:15px"><form action="belibarang.php" method="get"><input name="kode" type="hidden" value="<?php echo "$tampil[kd_barang]"; ?>">
	Jumlah beli : <input name="jumlah" type="text" size=3><input type="submit" value="Beli"></form></td>
	</tr>
	<tr height=25></tr>
