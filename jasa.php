...
?>
	...
	<td colspan=2 style="font-family:verdana ; font-size:28"><b><u><?php echo "$tampil[nama_jasa]"; ?></b></u></td>
	</tr>

	<tr>
	<td colspan=2 style="font-family:courier ; font-size:24"><?php echo "$tampil[deskripsi]"; ?></td>
	</tr>

	<tr>
	<td style="font-family:impact ; font-size:28; color:brick">Rp. <?php echo "$tampil[harga]"; ?>,00</td>
	<td style="font-family:verdana ; font-size:24"><form action="belijasa.php" method="get"><input name="kode" type="hidden" value="<?php echo "$tampil[kd_jasa]"; ?>">
	Jumlah beli : <input name="jumlah" type="text"><input type="submit" value="Beli"></form></td>
	</tr>
	<tr height=25></tr>
<?php
}
