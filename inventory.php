...
<head>
<title>Inventory Koperasi ISMUJM</title>
<meta charset="utf-8">
...
<table border=1 width=100%>
	...
	<tr>
	<td align="center" bgcolor="aeeaae"><b>Nama barang</b></td>
	<td align="center" bgcolor="aeeaae"><b>Harga barang</b></td>
	<td align="center" bgcolor="aeeaae"><b>Stok yang tersedia</b></td>
	<td align="center" bgcolor="aeeaae"><b>Deskripsi</b></td>
	<td align="center" bgcolor="aeeaae"><b>Foto</b></td>
	<td align="center" bgcolor="aeeaae"><b>Lakukan perubahan</b></td>
	<td align="center" bgcolor="aeeaae"><b>Ulangi perubahan</b></td>
	<td align="center" bgcolor="aeeaae"><b>Hapus data</b></td>
	</tr>

<?php
while($tampil=mysql_fetch_array($fetch_query))
{
?>
	<form action="ubah.php" method="post">
	<tr>
	<td bgcolor="daffb3" align="center"><input name="nama" type=text value="<?php echo "$tampil[nama_barang]"; ?>"></td>
	<td bgcolor="ffffcc" align="center"><input size=3 name="harga" type=text value="<?php echo "$tampil[harga]"; ?>"></td>
	<td bgcolor="daffb3" align="center"><input size=3 name="stok" type=text value="<?php echo "$tampil[jlh_stok]"; ?>"></td>
	<td bgcolor="ffffcc" align="center"><textarea name="deskripsi" cols=40 rows=10><?php echo "$tampil[deskripsi]"; ?></textarea></td>
	<td bgcolor="daffb3" align="center"><img width=100% src="images/<?php echo "$tampil[gambar]"?>"> 
	    <input name="kode" type="hidden" value="<?php echo "$tampil[kd_barang]"; ?>"></td>
	<td bgcolor="ffffcc" align="center"><input type="submit" value="Ubah"></td>
	<td bgcolor="daffb3" align="center"><input type="reset" value="Ulang"></td>
	</form>
	<td bgcolor="ffffcc" align="center"><form action="hapus.php" method="post">
	    <input name="del-kode" type="hidden" value="<?php echo "$tampil[kd_barang]"; ?>">
...
?>
	...
	<tr>
	<td bgcolor="e6ffcc"><input name="ins-nama" type=text></td>
	<td bgcolor="e6ffcc"><input size=3 name="ins-harga" type=text></td>
	<td bgcolor="e6ffcc"><input size=3 name="ins-stok" type=text></td>
	<td bgcolor="e6ffcc"><textarea name="ins-deskripsi" cols=40 rows=10></textarea></td>
	<td bgcolor="e6ffcc"><input name="kode" type="hidden" value="<?php echo "$tampil[kd_barang]"; ?>">
    	<input type="text" name="gambar">
	</td>
	<td bgcolor="e6ffcc" align="center"><input type="submit" value="Tambah"></td>
	<td bgcolor="e6ffcc" align="center"><input type="reset" value="Ulang"></td>
	</tr>
	</form>
